...
// keys in maps can only be comparable type not slice but array!
// delete(map,key)
// to compare map convert map to it's string representation using fmt.Sprintf and then compare
